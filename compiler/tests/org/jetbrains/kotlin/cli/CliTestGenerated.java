...
public class CliTestGenerated extends AbstractCliTest {
    ...
    public static class Jvm extends AbstractCliTest {
        ...
        @TestMetadata("experimentalBinaryScope.args")
        public void testExperimentalBinaryScope() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/cli/jvm/experimentalBinaryScope.args");
            doJvmTest(fileName);
        }
