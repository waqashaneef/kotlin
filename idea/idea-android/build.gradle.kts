...
dependencies {
    ...
    compileOnly(intellijDep()) { includeJars("openapi", "idea", "java-api", "java-impl", "platform-api", "platform-impl", "extensions", "util", "guava-21.0", "android-base-common", rootProject = rootProject) }
